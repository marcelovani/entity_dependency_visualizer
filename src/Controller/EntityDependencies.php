...
use \Drupal\entity_dependency_visualizer\D8Shim\MessengerTrait;
...
class EntityDependencies {
   ...
   *   An array.
   */
  public function getGraph($entity) {
    $graphviz = new Graphviz($this->getList($entity));
